...
class KITTIDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # AD OBSERVATION: this augmentation is also performed on test and validation
        #                 datasets. Therefore, they are not deterministic. Or is this
        #                 handles by setting seed?
